...
const TOOL_TITLE = 'Frais de Garde'
const TOOL_SUBTITLE = 'CPE vs Garderie Privée'
const TOOL_CATEGORY = 'Famille & Quotidien'
const TOOL_EMOJI = '👶'
const GRADIENT_START = '#7c3aed'
const GRADIENT_MIDDLE = '#8b5cf6'
const GRADIENT_END = '#a78bfa'
