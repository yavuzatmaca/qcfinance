...
const TOOL_TITLE = 'Taxe de Bienvenue'
const TOOL_SUBTITLE = 'Droits de mutation immobilière'
const TOOL_CATEGORY = 'Immobilier'
const TOOL_EMOJI = '🔑'
const GRADIENT_START = '#047857'
const GRADIENT_MIDDLE = '#10b981'
const GRADIENT_END = '#34d399'
