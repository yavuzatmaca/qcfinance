...
const TOOL_TITLE = 'Épargne Retraite'
const TOOL_SUBTITLE = 'REER et intérêts composés'
const TOOL_CATEGORY = 'Investissement'
const TOOL_EMOJI = '🌴'
const GRADIENT_START = '#4f46e5'
const GRADIENT_MIDDLE = '#6366f1'
const GRADIENT_END = '#818cf8'
