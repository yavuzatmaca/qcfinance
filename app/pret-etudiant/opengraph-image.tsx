...
const TOOL_TITLE = 'Prêt Étudiant'
const TOOL_SUBTITLE = 'Remboursement avec crédit d\'impôt'
const TOOL_CATEGORY = 'Dettes & Crédit'
const TOOL_EMOJI = '🎓'
const GRADIENT_START = '#ea580c'
const GRADIENT_MIDDLE = '#f97316'
    ...
    (
      <div style={{ height: '100%', width: '100%', display: 'flex', background: `linear-gradient(135deg, ${GRADIENT_START} 0%, ${GRADIENT_MIDDLE} 50%, ${GRADIENT_END} 100%)`, fontFamily: 'system-ui, sans-serif' }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '80px 60px' }}>
          ...
          <div style={{ fontSize: '64px', fontWeight: 'bold', color: 'white', marginBottom: '24px', display: 'flex', lineHeight: 1.1, letterSpacing: '-1px' }}>{TOOL_TITLE}</div>
          <div style={{ fontSize: '28px', color: 'rgba(255, 255, 255, 0.9)', marginBottom: '40px', display: 'flex', lineHeight: 1.3 }}>{TOOL_SUBTITLE}</div>
